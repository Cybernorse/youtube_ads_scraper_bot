...
class vidtao_ads(scrapy.Spider):
    ...
    def parse(self,response):
        ...
        email.send_keys("Randomvidtao10@mailinator.com")
    ...
    def vt_scrape(self,response):
        ...
        up_desc=self.driver.find_element_by_xpath('/html/body/jms-root/jms-layout/main/jms-module-instance/jms-instance-overview/div[2]/st-e-is-table/section/div/mat-card/mat-card-content/div/table/thead/tr/th[7]/div/div/div[1]')
        up_desc.click()
        up_desc.click()
        time.sleep(10)
        self.driver.save_screenshot('image10.png')
        while True:
            try:
                ...
                for i in youtube_id:
                    ...
                    helper.append(i)
                count+=1
                print(f"#########################    Crawler : 10   {count}    {len(youtube_id)}    ########################")
